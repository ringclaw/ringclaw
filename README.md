...
- **AI-Driven Actions** — agents auto-create notes, tasks, events, adaptive cards, Video bridges, FIJI client phone-call actions, and missed-call summaries. [→ Actions](https://ringclaw.github.io/ringclaw/features/actions.html)
