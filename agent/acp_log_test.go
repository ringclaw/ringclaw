...
func TestExtractNpxCacheDir(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			line: `ENOTEMPTY: directory not empty, rename 'C:\Users\x\AppData\Local\npm-cache\_npx\abc123\node_modules\@anthropic-ai\claude-agent-sdk' -> 'C:\Users\x\AppData\Local\npm-cache\_npx\abc123\node_modules\.tmp'`,
			want: `C:\Users\x\AppData\Local\npm-cache\_npx\abc123`,
		},
		{
			name: "hash is last segment without trailing slash",
			line: "ENOTEMPTY: directory not empty, rename '/Users/x/.npm/_npx/abc123'",
			want: "/Users/x/.npm/_npx/abc123",
		},
		{
			name: "no npx path",
