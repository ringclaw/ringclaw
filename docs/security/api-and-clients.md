...
| Authorize-mention OOB flow (`allow_group_mention_authorize`) | Disabled at startup (`ERROR allow_group_mention_authorize requires Private App + resolved owner DM`) |
